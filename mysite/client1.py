...
def motor_control(cmd):
    if cmd == 'forward':
        s1.ChangeFrequency(46.0)
        s1.ChangeDutyCycle(8.0)
        s2.ChangeFrequency(47.0)
        s2.ChangeDutyCycle(6.0)
        print 'forward'

    if cmd == 'backward':
        s1.ChangeFrequency(47.0)
        s1.ChangeDutyCycle(6.0)
        s2.ChangeFrequency(46.0)
        s2.ChangeDutyCycle(8.0)
        print 'backward'

    if cmd == 'stop':
        s1.ChangeFrequency(46.5)
        s1.ChangeDutyCycle(7.0)
        s2.ChangeFrequency(46.5)
